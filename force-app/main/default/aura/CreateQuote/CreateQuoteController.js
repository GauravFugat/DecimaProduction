({
    ...
    onPriceChange : function(component, event, helper) {  
        console.log('on price change function called');
        component.set("v.spinner", true);
        ...
        action3.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS"){
                // part of SU - 880
                component.set("v.isCreditExpToSetWarning",response.getReturnValue().isCreditCheckExpired);
                ...
                event.setParams({
                    "eventResponse" : response.getReturnValue().isCreditCheckExpired
                }); 
                //fire the event    
                event.fire();     
        ...
        helper.getPriceValues(component, event, helper,component.find("selectPrice").get("v.value"));
    },
