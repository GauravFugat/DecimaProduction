({
    doInitHelper : function(component,event,helper, fieldname,selectedState,UtilitiesSelected){
        ...
        action.setParams({  
            ...
            'UANames' : component.get("v.UANames")
        });
        action.setCallback(this, function(response) {
            ...
            $A.enqueueAction(setSelected);
               ...
               /* if(component.get("v.totalRecordsCount") > 100){
                    component.set("v.pageSize",100);
                }
                else{
                    component.set("v.pageSize",component.get("v.totalRecordsCount"));
                }*/
