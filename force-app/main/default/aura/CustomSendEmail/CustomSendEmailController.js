    ...
    doInit : function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS"){
                ...
                emailBody = emailBody.replace("{insert Quote Line Item Term}",  "");
                emailBody = emailBody.replace("{User first name}", response.userDetails.FirstName );
                emailBody = emailBody.replace("{Load Following Percent}", response.opp.Load_following__c);
