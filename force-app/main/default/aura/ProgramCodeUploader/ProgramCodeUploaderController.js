({
    ...
    sortByISOZone: function(component, event, helper) {
        ...
        sortByServiceClass: function(component, event, helper) {
        var currentOrder = component.get("v.sortAsc"),
            currentList = component.get("v.programCodes");
        currentOrder = !currentOrder;
        currentList.sort(function(a,b) {
            var t1 = a.Service_Class__c  == b.Service_Class__c , t2 = a.Service_Class__c  < b.Service_Class__c ;
            return t1? 0: (currentOrder?-1:1)*(t2?1:-1);
        });
        component.set("v.selectedTabsoft", "ServiceClass");
        if(currentOrder)
            component.set("v.arrowDirection", "arrowup");
        else
            component.set("v.arrowDirection", "arrowdown");
