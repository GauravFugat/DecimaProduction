({
    doInit: function(component, event, helper) {
        ...
        for(var i=0;i<allRecords.length;i++){
            //alert(allRecords[i].objAccount.Credit_Premium__c);
            //dev
            ...
            //allRecords[i].totalPrice = parseFloat(allRecords[i].objAccount.Base_Price__c) + ( (parseFloat(allRecords[i].salesMargin) + parseFloat(allRecords[i].brokerMargin)) * ( (parseFloat(allRecords[i].objAccount.Tax_Factor__c) * allRecords[i].objAccount.Credit_Premium__c) -1));
          //  allRecords[i].totalPrice = parseFloat(allRecords[i].objAccount.Base_Price__c) + ( (parseFloat(allRecords[i].salesMargin) + parseFloat(allRecords[i].brokerMargin)) * (parseFloat(allRecords[i].objAccount.POR_Factor__c) + parseFloat(allRecords[i].objAccount.Tax_Factor__c) -1));
           // alert(parseFloat(allRecords[i].totalPrice.toFixed(5)));
            totalPriceToPass.push(parseFloat(allRecords[i].totalPrice.toFixed(5)));
            //totalPriceToPass.push(parseFloat(parseFloat(allRecords[i].objAccount.Base_Price__c) + ( (parseFloat(allRecords[i].salesMargin) + parseFloat(allRecords[i].brokerMargin)) * ( (parseFloat(allRecords[i].objAccount.Tax_Factor__c) * allRecords[i].objAccount.Credit_Premium__c) -5)).toFixed(5)));
            //
        }
        ...
        console.log('24->here'+JSON.stringify(component.get("v.listOfAllPS"))); 
        //component.set("v.selectedTabsoft", "Term");
        //component.set("v.spinner", false);
        helper.getPriceValues(component, event, helper,component.get("v.selectedPriceId"));
    ...
    changeToggleButtonValue: function(component,event,helper) {
