	...
	doInit : function(component, event, helper) {
        ...
        action1.setCallback(this, function(response1) {
            ...
            if (state === "SUCCESS"){
                ...
                component.set("v.Obsolete",response1.getReturnValue().Obsolete);
                component.set("v.Opp",Opp);
                component.set("v.PDTrue", Opp.PDTrue);
                component.set("v.ValidateCreditCheck", Opp.ValidateCreditCheck);
